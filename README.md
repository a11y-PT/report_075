---
website: "CM Praia da Vitória"          # Entre as aspas escreve o nome do website
date: "05/06/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://www.cmpv.pt/"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://www.cmpv.pt/acessibilidade/" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Município da Praia da Vitória"         # Entre as aspas escrever o nome do owner do website
...
<details>
  ...
  <ul aria-label="lista de relatórios já efetuados">
    <li><a href="05062026_report.html">(05/06/2026). Relatório {{ page.website }}</a></li>
  </ul>
</details>
